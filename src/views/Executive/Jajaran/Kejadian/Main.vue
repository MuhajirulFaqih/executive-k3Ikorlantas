        ...
        <div class="e-topbar transparent">
            <b-row>
                <b-col cols="12 d-flex align-items-center" lg="6">
                    <h4><router-link :to="`/jajaran/detail/${$router.history.current.params.polda}`"><ph-caret-left class="phospor" /></router-link> <span class="semibold ml-3">Kejadian {{ $router.history.current.params.polda }}</span></h4>
                </b-col>
